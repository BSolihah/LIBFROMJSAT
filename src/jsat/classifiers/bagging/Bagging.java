...
package jsat.classifiers.bagging;
...
public class Bagging implements Classifier, Regressor, Parameterized
{
    ...
    /**Perform the sampling considering the imbalance ratio 
     * @param negatifSampleCount
     * @param positifSampleCount
     * @param samples the number of sample to take from the data set
     */
