           ...
           // IO io = new IO();
            for(int i = 0; i < toLearn; i++)
            {
              ...
              //  io.writeArray1DToFile(sampleCounts, i);
                ...
                if(dataSet instanceof ClassificationDataSet){
//                        ClassificationDataSet cds = NeighborBagging.nearestNeighbors((ClassificationDataSet)dataSet, true, 5);
                    //    learner.trainC(Bagging.getWeightSampledDataSet(cds, sampleCounts), features);
