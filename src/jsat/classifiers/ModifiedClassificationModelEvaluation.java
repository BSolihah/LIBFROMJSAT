...
import jsat.preprocessing.KMeanBasedUndersampling;
 ...
 * @author Edward Raff
 */
public class ModifiedClassificationModelEvaluation
{
    /**
    ...
    private PAMBasedUndersampling pam;
    private KMeanBasedUndersampling kmean;
     ...
     */
    public ModifiedClassificationModelEvaluation(Classifier classifier, ClassificationDataSet dataSet)
    {
     ...
     */
    public ModifiedClassificationModelEvaluation(Classifier classifier, ClassificationDataSet dataSet, boolean parallel)
    {
        this.kmean = new KMeanBasedUndersampling();
    ...
    {
//        ClassificationDataSet trainSet = sampling.clusterBasedSampling(firstTrainSet); error indexoutofbound
       //   ClassificationDataSet trainSet = pam.getRandomDataSetCluster(dataSet);
        ClassificationDataSet trainSet = pam.clusteringPAM(firstTrainSet);
       // ClassificationDataSet trainSet = kmean.clusteringXMean(firstTrainSet);
