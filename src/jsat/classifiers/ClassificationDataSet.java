...
public class ClassificationDataSet extends DataSet<ClassificationDataSet>
{
    ...
    @Override
    public ClassificationDataSet getSubset(List<Integer> indicies)
    {
    ...
    public void removeDataPoint(int index){
        if(index >= getSampleSize())
            throw new IndexOutOfBoundsException("There are not that many samples in the data set: " + index);
        else if(index < 0)
            throw new IndexOutOfBoundsException("Can not specify negative index " + index);
