 ...
 * @author Edward Raff
 */
public class NonSeedRandomBagging implements Classifier, Regressor, Parameterized
{
    ...
    protected boolean simultaniousTraining;
    protected Random random;
    protected List learners;
     ...
     */
    public NonSeedRandomBagging(Classifier baseClassifier)
    {
     ...
     */
    public NonSeedRandomBagging(Classifier baseClassifier, int extraSamples, boolean simultaniousTraining)
    {
        this(baseClassifier, extraSamples, simultaniousTraining, DEFAULT_ROUNDS, new Random());
     ...
     */
    public NonSeedRandomBagging(Classifier baseClassifier, int extraSamples, boolean simultaniousTraining, int rounds, Random random)
    {
     ...
     */
    public NonSeedRandomBagging(Regressor baseRegressor)
    {
     ...
     * @param simultaniousTraining controls whether base learners are trained sequentially or simultaneously 
     */
    public NonSeedRandomBagging(Regressor baseRegressor, int extraSamples, boolean simultaniousTraining)
    {
        this(baseRegressor, extraSamples, simultaniousTraining, DEFAULT_ROUNDS, new Random());
    }
     ...
     * @param random the source of randomness for sampling 
     */
    public NonSeedRandomBagging(Regressor baseRegressor, int extraSamples, boolean simultaniousTraining, int rounds, Random random)
    {
        this(extraSamples, simultaniousTraining, rounds, random);
    ...
    //For internal use
    private NonSeedRandomBagging(int extraSamples, boolean simultaniousTraining, int rounds, Random random)
    {
    ...
    public void train(final ClassificationDataSet dataSet, final boolean parallel)
    {
        ...
        for(int i = 0; i < rounds; i++)
        {
            ...
            if(simultaniousTraining && parallel)
            {
                ...
                {
                    Logger.getLogger(NonSeedRandomBagging.class.getName()).log(Level.SEVERE, null, ex);
     ...
     */
    public static ClassificationDataSet getSampledDataSet(ClassificationDataSet dataSet, 
            int[] sampledCounts)
    {
    ...
    @Override
    public NonSeedRandomBagging clone()
    {
        NonSeedRandomBagging clone = new NonSeedRandomBagging(extraSamples, simultaniousTraining, rounds, new Random(rounds));
        if(baseClassifier != null)
